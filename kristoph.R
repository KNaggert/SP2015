library(xlsx)
setwd("C:/Users/knaggert/Desktop/SP2015-master")

dir()

adsp <- read.delim("raw/glmTable_v1.txt", 1, stringsAsFactors = F)
...
write.table(adsp.bed, file = "adsp.bed", quote = F, row.names = F, sep = "\t")
